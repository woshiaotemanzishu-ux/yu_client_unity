...
- R173 FriendInvite: 34006 is an independent explicit full level-invite snapshot `pos_list:u16×{invitee_id:u64,pos:u8,name:string,lv:u16,career:u8,status:u8}`. Preserve wire order and duplicate invitee/pos entries; empty is loaded and clears only this slice. Startup and true level changes request exact empty `34001 -> 34006`; do not attach 34002-05/07-12, 11301-02, UI, red dots, rewards or configuration.
