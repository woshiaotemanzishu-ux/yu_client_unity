...
- R98 OnHook：13211=`i,i,i`、13212=`c,h,i,ObjectList,i,l,i,i,l,i`、13214=`i,i`，按 NetReader c/u8,h/u16,i/u32,l/u64 读完。13211/14 是增量，不能清空13212奖励；壳窗口打开只发空13212并显示缓存累计/剩余挂机时间和奖励项数。13216成功由服务端主动紧跟13212，客户端不得重拉，失败也不得出站。未迁：自动弹窗、全局 next_time 定时器、离线卡自动使用。
