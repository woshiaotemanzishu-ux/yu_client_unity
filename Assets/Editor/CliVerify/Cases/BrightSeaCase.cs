    ...
    public static class BrightSeaCase
    {
        ...
        private static int RunCore()
        {
            ...
            try
            {
                ...
                bool pass = intercept != null && on18900 != null && on18901 != null && on18915 != null && handlers != null
                    && handlers.Contains(18900) && handlers.Contains(18901) && handlers.Contains(18915);
                for (int proto = 18901; proto <= 18920; proto++)
                    pass &= handlers.Contains(proto) == (proto == 18901 || proto == 18915);
                ...
                pass &= Frames(frames, 18900) && !model.HasInfo && !model.HasCruiseLogs && !model.HasServerInfo
                ...
                pass &= mainRemaining == 0 && model.HasInfo && model.Picture == "next" && model.PictureVersion == 1
                    ...
                    && model.HasCruiseLogs && model.CruiseLogs.Count == 2 && model.CruiseLogs[0].AutoId == ulong.MaxValue;
                ...
                pass &= serverRemaining == 0 && model.HasInfo && model.HasServerInfo && model.EnemyServers.Count == 1
                    ...
                    && model.HasCruiseLogs && model.CruiseLogs.Count == 2 && model.CruiseLogs[1].AutoId == ulong.MaxValue;
                ...
                pass &= logsRemaining == 0 && model.HasCruiseLogs && model.CruiseLogs.Count == 1
                    ...
                    && model.HasInfo && model.SendList.Count == 0 && model.HasServerInfo && model.EnemyServers.Count == 0;
                ...
                pass &= logsRemaining == 0 && model.HasCruiseLogs && model.CruiseLogs.Count == 0
                    && model.HasInfo && model.HasServerInfo;
                ...
                frames.Clear();
                EventDispatcher.Emit(GlobalEvent.EVT_GAME_START);
                pass &= !controller.IsInitialized && !handlers.Contains(18900) && !handlers.Contains(18901) && !handlers.Contains(18915)
                    && !model.HasInfo && !model.HasCruiseLogs && !model.HasServerInfo && model.SendList.Count == 0
        ...
        {
            private readonly bool _info, _cruiseLogs, _serverInfo;
            ...
            {
                _info = m.HasInfo; _cruiseLogs = m.HasCruiseLogs; _serverInfo = m.HasServerInfo; _picture = m.Picture; _pictureVersion = m.PictureVersion;
