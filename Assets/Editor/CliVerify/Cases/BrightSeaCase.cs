    ...
    public static class BrightSeaCase
    {
        ...
        private static int RunCore()
        {
            ...
            try
            {
                ...
                pass = intercept != null && on18900 != null && on18901 != null && on18902 != null && on18904 != null && on18905 != null && on18915 != null && on18916 != null && on18917 != null && on18918 != null && handlers != null
                    && handlers.Contains(18900) && handlers.Contains(18901) && handlers.Contains(18902) && handlers.Contains(18904) && handlers.Contains(18905) && handlers.Contains(18915) && handlers.Contains(18916) && handlers.Contains(18917) && handlers.Contains(18918);
                for (int proto = 18901; proto <= 18920; proto++)
                    pass &= handlers.Contains(proto) == (proto == 18901 || proto == 18902 || proto == 18904 || proto == 18905 || proto == 18915 || proto == 18916 || proto == 18917 || proto == 18918);
                ...
                pass &= Frames(frames, 18900) && !model.HasInfo && !model.HasCruiseLogs && !model.HasShipInfo && !model.HasServerInfo && !model.HasAssistBGoldInfo && !model.HasShipStatus && !model.HasCruiseDetail
                    && !model.HasBattleStartResult && !model.HasExitError && model.LastExitErrorCode == 0
                ...
                frames.Clear();
                EventDispatcher.Emit(GlobalEvent.EVT_GAME_START);
                pass &= !controller.IsInitialized && !handlers.Contains(18900) && !handlers.Contains(18901) && !handlers.Contains(18902) && !handlers.Contains(18904) && !handlers.Contains(18905) && !handlers.Contains(18915) && !handlers.Contains(18916) && !handlers.Contains(18917) && !handlers.Contains(18918)
                    ...
                    && !model.HasExitError && model.LastExitErrorCode == 0 && frames.Count == 0;
            }
            finally
            {
        ...
        {
            private static readonly int[] Protocols = { 18900, 18901, 18902, 18904, 18905, 18915, 18916, 18917, 18918 };
        ...
        {
            private readonly bool _info, _cruiseLogs, _shipInfo, _serverInfo, _assistBGold, _hasShipStatus, _cruiseDetail, _battleStart, _exitError;
