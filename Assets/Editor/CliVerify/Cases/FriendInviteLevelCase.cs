...
namespace Shenxiao.EditorTools
{
    public static class FriendInviteLevelCase
    {
        ...
        private static int RunCore()
        {
            ...
            bool oldHas = m.HasLevelInfo, oldShare = FriendInviteModel.ShareOpen;
            ...
            bool old34000 = handlers != null && handlers.Contains(34000), old34001 = handlers != null && handlers.Contains(34001), old34006 = handlers != null && handlers.Contains(34006);
            object old34000Ref = old34000 ? handlers[34000] : null, old34001Ref = old34001 ? handlers[34001] : null, old34006Ref = old34006 ? handlers[34006] : null;
            try
            {
                c.Init(); m.Reset(); var on = typeof(FriendInviteController).GetMethod("On34006", NP);
                var onInfo = typeof(FriendInviteController).GetMethod("On34001", NP);
                pass = on != null && onInfo != null && intercept != null && handlers != null
                    && lastLevel != null && roleReady != null && eventHandlers != null && icons != null && boxes != null;
                for (int p = 34000; p <= 34012; p++) pass &= handlers.Contains(p) == (p == 34000 || p == 34001 || p == 34006);
                var frames = new List<byte[]>(); intercept.SetValue(null, new Func<byte[], bool>(f => { frames.Add(f); return true; }));
                c.RequestLevelInfo(); pass &= Frames(frames, 34006); frames.Clear(); c.RequestStartup(); pass &= Frames(frames, 34001, 34006);
                ...
                role.MarkBaseInfoReady(); role.Level = 654321; lastLevel.SetValue(c, 0); frames.Clear(); EventDispatcher.Emit(GlobalEvent.EVT_ROLE_INFO_UPDATE); pass &= Frames(frames, 34001, 34006);
                ...
                Invoke(on, c, new CliVerify.Pkt().H(0).Bytes(), out remain); pass &= remain == 0 && m.HasLevelInfo && m.LevelInviteEntries.Count == 0;
                c.Dispose(); frames.Clear(); EventDispatcher.Emit(GlobalEvent.EVT_ROLE_INFO_UPDATE);
                pass &= !handlers.Contains(34000) && !handlers.Contains(34001) && !handlers.Contains(34006) && !m.HasLevelInfo && m.LevelInviteEntries.Count == 0
            ...
            finally
            {
                ...
                if (handlers != null)
                {
                    handlers.Remove(34000); handlers.Remove(34001); handlers.Remove(34006);
                ...
                bool restored = c.IsInitialized == was && m.GetStatus == oldGet && m.RecoverTime == oldRecover && m.DailyCount == oldDaily && m.TotalCount == oldTotal
                    && m.HasLevelInfo == oldHas && SameEntries(m.LevelInviteEntries, oldEntries) && FriendInviteModel.ShareOpen == oldShare
                ...
                if (handlers != null) restored &= handlers.Contains(34000) == old34000 && handlers.Contains(34001) == old34001 && handlers.Contains(34006) == old34006
                    && (!old34000 || ReferenceEquals(handlers[34000], old34000Ref)) && (!old34001 || ReferenceEquals(handlers[34001], old34001Ref)) && (!old34006 || ReferenceEquals(handlers[34006], old34006Ref));
