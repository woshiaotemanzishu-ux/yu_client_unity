...
namespace Shenxiao.EditorTools
{
    ...
    public static class CliVerify
    {
        ...
        public static void DungeonReadContinuation() { Run(DungeonReadContinuationCase.Run, 60.0); }
        ...
        /// <summary>背包/仓库按钮、装备穿戴/物品使用/熔炼/扩容出站与真实 Raycaster 点击专项。</summary>
        public static void BagInteraction()
        {
            Run(BagInteractionCase.Run, 120.0);
        }
        ...
        /// <summary>神陨禁区284族安全读侧、键控全量与推送重查回归。</summary>
        public static void KfHolyArea()
        {
            Run(KfHolyAreaCase.Run, 60.0);
        }
