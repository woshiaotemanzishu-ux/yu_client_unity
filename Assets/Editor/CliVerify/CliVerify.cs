        ...
        public static void RenderAll()
        {
            Run(async () =>
            {
                ...
                Debug.Log("CLIVERIFY ALL protoDelta=" + p + " dotask=" + d + " partner=" + e
                    + " suitclt=" + s + " rushgift=" + g + " outward=" + o + " snatchtreasure=" + st + " wxsub=" + wxsub
                ...
                foreach (int r in new[] { p, d, e, s, g, o, t, q, u, j, n, v, w, f, a, b, c, k, m, gp, rl, sg, iv, eg, jw, rg, ch, fm, tm, df, dh, cv, sh, rk, gc, ge, bs, kb, mr, md, c0, c2, c3, c4, c5, c6, g1, g2, g3, g4, g5, mk, sc, lo, fa, ld, pc, ga, se, sf, bq, pe, pi, pu, by, lu, db, ap, ar, me, ks, re, gb, ds, ma, dr, dm, rv, ac, gd, ns, gw, tc, et, hb, mwa, np, dp, mb, ksr, jjc, jjcr, bsea, st, wxsub })
                    if (r != 0) return r;
                return 0;
            }, 1500.0);
        }
