namespace Shenxiao.Framework.Event
{
    ...
    public static class GlobalEvent
    {
        ...
        /// <summary>创角结果(10003),参数: result (int,1成功/3重名/4非法字符/5长度/6已有角色/7敏感词)。</summary>
        ...
        /// <summary>宝宝数据或操作结果更新（参数：int protoId；读取 BabyModel 对应状态/Last*Result）。</summary>
        ...
        public const string EVT_ARMOR_MAKE_RESULT = "EVT_ARMOR_MAKE_RESULT";
        ...
        /// <summary>循环任务进度更新(携带 taskType)，读取 TaskModel 的服务端权威进度缓存。</summary>
        public const string EVT_TASK_CIRCLE_PROGRESS_UPDATED = "EVT_TASK_CIRCLE_PROGRESS_UPDATED";
        ...
        public const string EVT_AUTOBRUSH_STAGE_REWARD_UPDATED = "EVT_AUTOBRUSH_STAGE_REWARD_UPDATED";
