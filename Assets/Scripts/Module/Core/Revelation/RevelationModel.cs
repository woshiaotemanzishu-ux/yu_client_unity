...
namespace Shenxiao.Module.Core.Revelation
{
    public sealed class RevelationModel
    {
        ...
        public bool HasError { get; private set; } public uint LastErrorCode { get; private set; } public ushort MaxFigureId { get; private set; } public ushort CurrentFigureId { get; private set; } public ulong Power { get; private set; } public bool HasData { get; private set; } public IReadOnlyList<Gathering> Gatherings => _roGatherings; public IReadOnlyList<Suit> Suits => _roSuits; public IReadOnlyList<Skill> Skills => _roSkills;
        ...
        public void ReplaceError(uint code) { LastErrorCode = code; HasError = true; }
        ...
        public void Reset() { HasError = false; LastErrorCode = 0; MaxFigureId = 0; CurrentFigureId = 0; Power = 0; _gatherings.Clear(); _suits.Clear(); _skills.Clear(); HasData = false; }
    }
}
