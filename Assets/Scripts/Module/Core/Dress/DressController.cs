...
namespace Shenxiao.Module.Core.Dress
{
    public sealed class DressController : BaseController
    {
        ...
        protected override void Register() { RegisterProtocal(Proto.DRESS_INFO, On11200); RegisterProtocal(Proto.DRESS_INACTIVE_POWER, On11205); }
...
#if UNITY_EDITOR
            byte[] frame = UserMsgAdapter.Encode(Proto.DRESS_INACTIVE_POWER, "ci", type, dressId); if (s_outboundIntercept != null && s_outboundIntercept(frame)) return;
#endif
            SendFmt(Proto.DRESS_INACTIVE_POWER, "ci", type, dressId); }
        ...
        private void On11205(NetReader r) { DressModel.Instance.ReplaceInactivePower(r.ReadU8(), r.ReadU32(), unchecked((ulong)r.ReadU64())); }
