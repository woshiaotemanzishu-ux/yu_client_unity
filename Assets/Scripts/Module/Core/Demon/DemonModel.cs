...
namespace Shenxiao.Module.Core.Demon
{
    ...
    public sealed class DemonModel
    {
        ...
        public byte OpenState { get; private set; } public bool HasData { get; private set; } public bool HasFettersData { get; private set; } public bool HasPaintingsData { get; private set; } public bool HasBlessingData { get; private set; } public uint BlessingValue { get; private set; } public IReadOnlyList<Entry> Demons => _readOnlyDemons; public IReadOnlyList<uint> Fetters => _readOnlyFetters; public IReadOnlyList<byte> Paintings => _readOnlyPaintings;
        ...
        public void Reset() { OpenState = 0; _demons.Clear(); _fetters.Clear(); _paintings.Clear(); BlessingValue = 0; HasData = false; HasFettersData = false; HasPaintingsData = false; HasBlessingData = false; }
    }
}
