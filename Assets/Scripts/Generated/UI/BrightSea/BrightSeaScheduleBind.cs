...
// 来源: cdn/resource/game/brightSea/BrightSeaSchedule.json
using TMPro;
using UnityEngine;
...
{
    public partial class BrightSeaScheduleBind : BaseView
    {
        ...
        public GameObject _tpl_BrightSeaSchItem;
        ...
        protected override void BindNodes()
        {
            ...
            EnsureBound(nameof(_tpl_BrightSeaSchItem), _tpl_BrightSeaSchItem);
        }
    }
}
