...
// 来源: cdn/resource/game/godBeast/GodBeastSelectItem.json
using TMPro;
using UnityEngine;
...
{
    public partial class GodBeastSelectItemBind : BaseView
    {
        public RectTransform _item_con;
        ...
        {
            EnsureBound(nameof(_item_con), _item_con);
