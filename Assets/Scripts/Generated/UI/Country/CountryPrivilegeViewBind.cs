...
// 来源: cdn/resource/game/country/CountryPrivilegeView.json
using TMPro;
using UnityEngine;
...
{
    public partial class CountryPrivilegeViewBind : BaseView
    {
        public Image bg;
        ...
        public GameObject _tpl_PrivilegeItem;
        ...
        protected override void BindNodes()
        {
            ...
            EnsureBound(nameof(_tpl_PrivilegeItem), _tpl_PrivilegeItem);
        }
    }
}
