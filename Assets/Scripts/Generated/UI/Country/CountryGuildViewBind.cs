...
// 来源: cdn/resource/game/country/CountryGuildView.json
using TMPro;
using UnityEngine;
...
{
    public partial class CountryGuildViewBind : BaseView
    {
        public Image bg;
        ...
        public GameObject _tpl_CountryGuildItem;
        ...
        protected override void BindNodes()
        {
            ...
            EnsureBound(nameof(timeLb), timeLb);
            ...
            EnsureBound(nameof(_tpl_CountryGuildItem), _tpl_CountryGuildItem);
        }
    }
}
