...
// 来源: cdn/resource/game/guildFight/GuildFightSchedule.json
using TMPro;
using UnityEngine;
...
{
    public partial class GuildFightScheduleBind : BaseView
    {
        ...
        public GameObject _tpl_GuildFightSchItem;
        ...
        protected override void BindNodes()
        {
            ...
            EnsureBound(nameof(_tpl_GuildFightSchItem), _tpl_GuildFightSchItem);
        }
    }
}
