...
// 来源: cdn/resource/game/alert/AlertTypeThree.json
using TMPro;
using UnityEngine;
...
{
    public partial class AlertTypeThreeBind : BaseView
    {
        public Image bg;
        ...
        public TextMeshProUGUI _lb_top_html;
        public TextMeshProUGUI _lb_down_html;
        ...
        protected override void BindNodes()
        {
            ...
            EnsureBound(nameof(_lb_top_html), _lb_top_html);
            EnsureBound(nameof(_lb_down_html), _lb_down_html);
        }
    }
}
