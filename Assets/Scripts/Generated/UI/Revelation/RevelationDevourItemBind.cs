...
// 来源: cdn/resource/game/revelation/RevelationDevourItem.json
using TMPro;
using UnityEngine;
...
{
    public partial class RevelationDevourItemBind : BaseView
    {
        ...
        public Image reddot;
        public GameObject _tpl_RevelationEquipItem;
        ...
        protected override void BindNodes()
        {
            ...
            EnsureBound(nameof(star_0), star_0);
            ...
            EnsureBound(nameof(_tpl_RevelationEquipItem), _tpl_RevelationEquipItem);
        }
    }
}
