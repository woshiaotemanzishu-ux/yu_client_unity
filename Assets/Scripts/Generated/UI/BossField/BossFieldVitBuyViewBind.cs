...
// 来源: cdn/resource/game/bossField/BossFieldVitBuyView.json
using TMPro;
using UnityEngine;
...
{
    public partial class BossFieldVitBuyViewBind : BaseView
    {
        public Image img_bg;
        public Image img_bg2;
        public Image img_bg3;
        public TextMeshProUGUI lb_title;
        public TextMeshProUGUI lb_1;
        public TextMeshProUGUI lb_2;
        public RectTransform gp_price;
        public TextMeshProUGUI lb_price;
        public Image price_image;
        public TextMeshProUGUI price_text;
        public RectTransform gp_price_2;
        public TextMeshProUGUI lb_price_2;
        public Image price_image_2;
        ...
        protected override void BindNodes()
        {
            ...
            EnsureBound(nameof(lb_1), lb_1);
            EnsureBound(nameof(lb_2), lb_2);
            ...
            EnsureBound(nameof(gp_price_2), gp_price_2);
            EnsureBound(nameof(lb_price_2), lb_price_2);
            EnsureBound(nameof(price_image_2), price_image_2);
