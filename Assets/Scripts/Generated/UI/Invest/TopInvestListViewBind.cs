...
// 来源: cdn/resource/game/invest/TopInvestListView.json
using TMPro;
using UnityEngine;
...
namespace Shenxiao.Generated.UI.Invest
{
    public partial class TopInvestListViewBind : BaseView
    {
        ...
        protected override void BindNodes()
        {
            ...
            EnsureBound(nameof(back_num), back_num);
