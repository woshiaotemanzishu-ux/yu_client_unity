...
// 来源: cdn/resource/game/carnival/CarnivalMainView.json
using TMPro;
using UnityEngine;
using UnityEngine.UI;
using Shenxiao.Framework.UI;

namespace Shenxiao.Generated.UI.Carnival
{
    public partial class CarnivalMainViewBind : BaseView
    {
        ...
        public GameObject _tpl_CarnivalMainItem;
        ...
        protected override void BindNodes()
        {
            ...
            EnsureBound(nameof(_tpl_CarnivalMainItem), _tpl_CarnivalMainItem);
