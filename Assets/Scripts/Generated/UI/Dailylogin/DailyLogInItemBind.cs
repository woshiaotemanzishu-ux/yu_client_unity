...
// 来源: cdn/resource/game/dailylogin/DailyLogInItem.json
using TMPro;
using UnityEngine;
...
{
    public partial class DailyLogInItemBind : BaseView
    {
        ...
        protected override void BindNodes()
        {
            ...
            EnsureBound(nameof(_img_next_day), _img_next_day);
