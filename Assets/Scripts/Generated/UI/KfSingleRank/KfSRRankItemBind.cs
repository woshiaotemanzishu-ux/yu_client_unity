...
// 来源: cdn/resource/game/kfSingleRank/kfSRRankItem.json
using TMPro;
using UnityEngine;
...
{
    public partial class KfSRRankItemBind : BaseView
    {
        public Image _Image1;
        public TextMeshProUGUI _lb_layer;
        public TextMeshProUGUI _lb_name;
        public TextMeshProUGUI _lb_time;
        public TextMeshProUGUI _lb_time_self;
        ...
        protected override void BindNodes()
        {
            ...
            EnsureBound(nameof(_lb_time_self), _lb_time_self);
        }
    }
}
