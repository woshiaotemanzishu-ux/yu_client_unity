...
// 来源: cdn/resource/game/composite/SelectCompositeMatView.json
using TMPro;
using UnityEngine;
...
{
    public partial class SelectCompositeMatViewBind : BaseView
    {
        public Image bg;
        ...
        public ScrollRect mat_scroller2;
        ...
        protected override void BindNodes()
        {
            ...
            EnsureBound(nameof(mat_scroller2), mat_scroller2);
        }
    }
}
