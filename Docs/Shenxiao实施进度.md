...
- 最新推进轮次：R594。复核并机器化KfHolyArea 284族最后三个未分类事务：28404维护跨服加入表、按服务器PK/camp与动作锁切场景并以`is_task`串接30011任务；28408先写归属领奖表再按世界等级/建筑真实发奖但active不写同号ACK；28409先持久化积分档位再真实发奖。
- 28404/08/09进入hard-negative，与既有28406/19/20 killlist完整分类本族六个当前活缺口；现有28400/01/03/05/07/10/11/12/13/14/15/16/17/21/22/23及GAME_START保持不变，baseline只补人工说明且历史3/19计数冻结。正向`coverage_20260802_235807.md`通过；三常量探针在`coverage_20260802_235947.md`被F同时拒绝；恢复后的`coverage_20260803_000122.md`为A～M全PASS，治理分类`81/104/146`，raw仍为`1256/331/20/77.5%`。
