...
- 最新完成轮次：R496，在既有TopPk 28100错误切片上新增28101基本信息、28105段位奖励、28107活动状态、28111匹配对手、28112阶段、28113结算raw delta、28115排行榜和28117段位提升八个安全读侧号。GAME_START不清旧态并严格空发28101→28105→28107；28115只显式查询，所有列表保序保重、空表loaded，u64角色id/战力无损。
- 28102/03/06领奖、28104购买、28110/14匹配写状态和28116退出战场继续DEFER；不接UI、配置、红点、Toast、场景、奖励/钱包或本地段位推导。Unity专项、离线编译与全量治理均通过；当前`registered=1120 / liveDefined=1468 / liveGap=470 / errorExit=10 / effective=998/1468=68.0%`，281族`registered9/liveGap6/dead0/pending`，报告`coverage_20260730_040251.md`。
