...
- 最新推进轮次：R613。按R123/R137/R539既有Revelation读侧和负约束，把28601/02装备穿脱、28603吞噬、28604聚灵升级、28605被动技能升级与28607形象切换六条写事务补入hard-negative。
- 本族六个剩余未治理活缺口已全部分类；现有28606/09、RevelationController/Model/Case和降级Prefab/View保持不变，28600继续硬负约束、28608继续KILL。baseline只补人工说明且历史0/10计数冻结。正向`coverage_20260803_025548.md`与最终`coverage_20260803_025849.md`均A～M全PASS，最终治理分类为`81/181/69`；六常量故障报告`coverage_20260803_025723.md`仅F精确拒绝目标号。编译为79条既有warning、0 error。
