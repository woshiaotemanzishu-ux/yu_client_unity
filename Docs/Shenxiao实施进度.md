...
- 最新完成轮次：R507，在既有称号 41101 权威列表上新增四个安全读侧：S2C-only 41104 激活通知、S2C-only 41105 场景角色称号通知、显式 `id:u32` 查询 41107 战力快照，以及 S2C-only 41108 移除通知。四份最后原始切片逐包完整替换、彼此及 41101 双向隔离，零值与全位最大值有效；41107 无回复保留旧值，GAME_START 仍只发送 41101。41104 不复刻旧端自动佩戴，41105 不接场景表现，41108 不补丁式改写权威列表。
- 41102/41103佩戴卸下、41106升阶、41109道具激活、41110过期取消均为真实写操作，继续DEFER。未接UI、场景表现、配置、背包、属性、Toast、事件或红点。Unity专项与既有Designation回归、覆盖治理均通过；当前`registered=1237 / liveDefined=1468 / liveGap=353 / errorExit=10 / effective=1115/1468=76.0%`，411族`registered5/liveGap4/dead1/pending`，报告`coverage_20260730_072004.md`。
