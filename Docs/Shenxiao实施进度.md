...
- 最新完成轮次：R477，复核微信 11301/11302/11306 后继续 DEFER：11301 虽是只读分享次数，但当前 FriendInvite 五包启动/等级链和微信分享产品边界明确排除它；11302 会写分享次数、DB 并真实发奖；11306 是模板列表查询且订阅成功后还会主动推送，需模板配置、微信 SDK 和设置页消费一起迁移。三号均不新增孤立 Proto/handler/sender/model。
