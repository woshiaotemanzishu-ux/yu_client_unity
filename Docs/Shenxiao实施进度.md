...
- 最新完成轮次：R504，在既有Dungeon 610家族新增61031/32/33/34/35/41/42七个安全只读号。61031/32/34/35为严格空显式查询，61041请求dun_id，61042请求dun_type；全部无回复路径保留旧切片，不挂GAME_START、公会入口或场景。61032/34保留wire原序与重复项，61035按返回dun_id键控，61041保存真实零经验，61042按返回dun_type键控；61033保持S2C-only，并按服务端`lists:keystore(AutoId,1,...)`只替换首个同auto_id项、未知键追加。
- 61028批量扫荡、61043额外奖励领取、61052快速出怪、61054阶段奖励、61056临时技能、61090伴侣答案均会改变次数/资产/战斗/交互状态，继续DEFER；61057/60/91/93维持既有killlist。未接结社守卫/额外奖励UI、配置、事件、红点、场景、自动战斗、本地发奖或资产链。Unity专项与覆盖治理已通过；当前`registered=1225 / liveDefined=1468 / liveGap=365 / errorExit=10 / effective=1103/1468=75.1%`，610族`registered44/liveGap10/dead20/pending`，报告`coverage_20260730_061409.md`。
