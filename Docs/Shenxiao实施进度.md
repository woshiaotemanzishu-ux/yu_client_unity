...
- 最新完成轮次：R590。复核并机器化JJC 280族全部五个当前活缺口：28005真实扣资源并增加daily/挑战次数；28012停止battle、清场景和动作锁；28015立即结算并清假人；28017持久化突破已领ID并发奖；28008仅余老端接收壳，服务端handle与唯一调度整段注释。
- 28005/12/15/17进入hard-negative、28008进入killlist；28000/01/02/03/04/09/10/13/14及GAME_START保持不变，baseline只补人工说明且历史3/11计数冻结。五常量故障注入分别被F拒绝四号、G拒绝28008；最终`coverage_20260802_232517.md`为A～M全PASS、F=95条、G=174条、治理分类`81+95+155=331`，raw指标保持`1256/331/20/77.5%`。
