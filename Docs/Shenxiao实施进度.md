...
- 最新完成轮次：R567。新增L段逐族校验coverage的`legacy_unverified`区；当前150族剩`15011,15028`，152族剩`15218,15221,15222`，合计2族/5号。
- 报告生成器、K/L统一只把带非空evidence的killlist，以及协议号/规则/evidence均合法的硬负约束计入治理；无证据坏项在失败报告里重新落入未治理组，禁止清单自身挂红但报告仍掩盖缺口。
- `15023 evidence=null + 报告漏150族`组合探针令C/G失败，K仍正确重分组，L精确报告1!=2并定位150。恢复后的`coverage_20260802_201419.md`为`registered=1256/liveDefined=1468/liveGap=331/errorExit=20/active=1137/1468=77.5%`，A～L全PASS、`EXIT 0`，正式baseline与治理清单未改。
