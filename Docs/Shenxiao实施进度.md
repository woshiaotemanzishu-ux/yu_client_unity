...
- 最新推进轮次：R615。按R495既有RuneTreasure读侧和负约束，把41604抽取、41605/06取物、41607阶段领奖、41609积分兑换与41622任务领奖六条资产事务补入hard-negative。
- 本族六个剩余未治理活缺口已全部分类；现有十个读侧Controller/Model/Case、GAME_START/安全重查序列、转换Prefab/Bind保持不变，41611继续KILL，41614继续C2S-only DEFER且不伪列liveGap。baseline只补人工说明且历史0/17计数冻结；正向`coverage_20260803_031414.md`、六常量故障`coverage_20260803_031602.md`和最终`coverage_20260803_031726.md`完成，最终A～M全PASS、F=194/G=174/M=`81+194+56=331`。
