...
- 最新已验证轮次：R210，新增 HolyTerritory 28300 的 S2C-only 原始错误快照；不含请求、UI、场景、启动链或其余 283xx。
- Unity ProtocolCoverage：`registered=1017`，`liveDefined=1468`，`liveGap=573`，未注册族错误出口20个；真实活协议覆盖 `895/1468=61.0%`，A～E 治理断言全通过。
