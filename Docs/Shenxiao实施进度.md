...
- 最新推进轮次：R600。复核并机器化Unreal 149族四个当前未分类事务：14901交换背包/幻饰位实例、解锁部位并推进多下游；14902卸回默认背包并重算属性；14903扣材料且保留实例ID、重写三张goods表并回显新类型ID；14905现服仅type1扣料强化，type2只失败。
- 14901/02/03/05进入hard-negative，完整分类本族四个当前活缺口；现有14900/04/06/07/08、五份读侧切片与GAME_START `14904(cell1..6)→14908`保持不变，baseline只补人工说明且历史0/9计数冻结。正向`coverage_20260803_005915.md`通过；四常量探针在`coverage_20260803_010050.md`被F同时拒绝；恢复后的`coverage_20260803_010218.md`为A～M全PASS，治理分类`81/123/127`，raw仍为`1256/331/20/77.5%`。
