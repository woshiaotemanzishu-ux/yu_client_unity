...
- 最新已验证轮次：R212，在既有 Revelation 数据底座新增 28600 的 S2C-only 原始错误快照；不含请求、UI、事件、重拉或28601-28605/28607/28608。
- Unity ProtocolCoverage：`registered=1019`，`liveDefined=1468`，`liveGap=571`，未注册族错误出口18个；真实活协议覆盖 `897/1468=61.1%`，A～E 治理断言全通过。
