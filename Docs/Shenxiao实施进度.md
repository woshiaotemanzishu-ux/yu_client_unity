...
- 最新完成轮次：R503，扩展既有HolyTerritory 28300错误切片，新增28301/02/06/07/08/09/10/11/12/13/14/16/17/18/19十五个安全读侧号。GAME_START不清旧态，严格发送28301(1)→28301(2)→28301(3)→28314→28316→28318；28301/28312按回包层号键控，28311按(层号,boss)复合键控，28302/10/14完整覆盖，全部列表保留线序、重复和空表loaded。28309只修补已加载同层首个匹配Boss，未知键不创建；28317/19增量raw分别不污染28301积分与28318绝对疲劳。
- 28303进入、28304退出、28305关注/取消关注继续DEFER；28315旧端唯一发送已注释、服务端只写daily且从不写同号回包，维持KILL/不注册。服务端28302空排行错参和28308无死亡记录误投pt_460均会造成无回复，客户端必须保留旧快照，不清空、不重试。未接UI、配置、红点、场景/复活/自动战斗、toast、奖励、资产或事件。Unity专项、离线重建与覆盖治理均通过；当前`registered=1218 / liveDefined=1468 / liveGap=372 / errorExit=10 / effective=1096/1468=74.7%`，283族`registered16/liveGap2/dead1/pending`，报告`coverage_20260730_055707.md`。
