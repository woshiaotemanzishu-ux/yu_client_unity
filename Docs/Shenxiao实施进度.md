...
- 最新已验证轮次：R211，在既有 NoonParty 数据底座新增 28500 的 S2C-only 原始错误快照；不含请求、UI、事件、重拉或28501/28502。
- Unity ProtocolCoverage：`registered=1018`，`liveDefined=1468`，`liveGap=572`，未注册族错误出口19个；真实活协议覆盖 `896/1468=61.0%`，A～E 治理断言全通过。
